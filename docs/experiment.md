...
|deberta_v3|[train29]|[infer27.1]|0.8794|0.882|先頭文字の後処理, 0.5以上を先に計算, 2個以上|
|deberta_v3|[train29]|[infer27.2]|0.8794|0.883|先頭文字の後処理, 0.5以上を先に計算, 3個以上|
|deberta_v3|[train29]|[infer27.2]|0.8794|0.879|先頭文字の後処理, 0.5以上を先に計算, 4個以上|
|pseudo_mcdrop|[train29]|[infer29]|0.8878|0.885||
|pseudo_mcdrop|[train29]|[infer29.1]|0.8900|0.887|先頭文字の後処理|
|pseudo_mcdrop|[train29]|[infer29.2]|0.8900|0.886|先頭文字の後処理, 0.5以上を先に計算, 2個以上|
|pseudo_mcdrop|[train29]|[infer29.3]|0.8900|0.887|先頭文字の後処理, 0.5以上を先に計算, 3個以上, 平均のほうが若干良さそう|
|pseudo_mcdrop|[train29]|[infer29.4]|0.8900|0.883|先頭文字の後処理, 0.5以上を先に計算, 4個以上|
|pseudo_mcdrop|[train29]|[infer29.5]|0.8900|error|先頭文字の後処理, WBF|
...
[infer27.2]:https://www.kaggle.com/code/takamichitoda/nbme-infer-by-pytorch?scriptVersionId=90909717
[infer27.3]:https://www.kaggle.com/code/takamichitoda/nbme-infer-by-pytorch?scriptVersionId=90909977
...
[infer29.2]:https://www.kaggle.com/code/takamichitoda/nbme-infer-by-pytorch?scriptVersionId=91005661
[infer29.3]:https://www.kaggle.com/code/takamichitoda/nbme-infer-by-pytorch?scriptVersionId=91005705
[infer29.4]:https://www.kaggle.com/code/takamichitoda/nbme-infer-by-pytorch?scriptVersionId=91005995
[infer29.5]::https://www.kaggle.com/code/takamichitoda/nbme-infer-by-pytorch?scriptVersionId=91007238

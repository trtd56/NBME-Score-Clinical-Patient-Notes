...
|pseudo_mcdrop|[train29]|[infer29.2]|0.8900|0.882|先頭文字の後処理, 0.5以上を先に計算, 2個以上|
|pseudo_mcdrop|[train29]|[infer29.3]|0.8900|0.883|先頭文字の後処理, 0.5以上を先に計算, 3個以上|
|pseudo_mcdrop|[train29]|[infer29.4]|0.8900|0.879|先頭文字の後処理, 0.5以上を先に計算, 4個以上|
